...
const LAYOUTS: Layout[] = [
  { id: "one-portrait", name: "세로 1장", thumb: "/images/layout1.png" },
  { id: "one-landscape", name: "가로 1장", thumb: "/images/layout2.png" },

  { id: "two-h", name: "가로 2장", thumb: "/images/layout3.png" },
  { id: "two-v", name: "세로 2장", thumb: "/images/layout4.png" },

  // 위 1행: 1칸+1칸, 아래 2행: 큰 1칸(두 행 차지)
  { id: "2plus1", name: "2+1 레이아웃", thumb: "/images/layout5.png" },

  // 위 2행: 큰 1칸(두 행 차지), 아래 1행: 1칸+1칸
  { id: "1plus2", name: "1+2 레이아웃", thumb: "/images/layout6.png" },

  // 위 1행: 1칸+1칸, 아래 가운데 1칸
  { id: "2top1bottom", name: "2상단1하단", thumb: "/images/layout7.png" },

  { id: "two-by-two", name: "2x2 그리드", thumb: "/images/layout8.png" }
];
