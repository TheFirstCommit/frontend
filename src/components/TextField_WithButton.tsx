...
export const TextField_WithButton:React.FC<TextFieldProps> = ({value, className, onChange, name, hasError, errorMessage, isValid, onBlur}) => {
    ...
    return (
        <div className='w-full'>
            <div className={`flex w-full h-14 bg-white border rounded-md transition-colors duration-200 ${getBorderColor()}`}>
                ...
                <Button className='ml-auto my-2 mx-5' text='확인' variant='primary' />
            </div>
            <div>
